...
Revision ID: e7ae8f7c57b4
Revises: 01ab5a8becde
Create Date: 2024-12-03 16:17:28.577795
...
revision: str = 'e7ae8f7c57b4'
down_revision: Union[str, None] = '01ab5a8becde'
...
def upgrade() -> None:
    ...
    sa.Column('followID', sa.String(length=255), nullable=False),
    sa.Column('follow_at', sa.String(length=255), nullable=True),
